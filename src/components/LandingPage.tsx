          ...
          <section className="mb-20 md:mb-32 text-center relative">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 animate-slideIn px-4" style={{ animationDelay: '0.4s' }}>
              <div className="text-center">
                <div className="text-3xl md:text-5xl font-black text-primary mb-1 md:mb-2">100+</div>
                <div className="text-gray-500 uppercase text-xs md:text-sm tracking-wider">Артистов</div>
              </div>
