      ...
      <CardContent className="space-y-6">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
          ...
          <ol className="text-sm text-blue-300 space-y-1 list-decimal list-inside">
            ...
            <li>Система автоматически разобьёт файл по исполнителям (берёт значение из колонки "Исполнитель")</li>
            <li>Для каждого исполнителя выберите артиста из вашей системы (привязка вручную)</li>
            <li>Установите % удержания лейбла (0-100%) - он вычтется из итоговой суммы в PDF</li>
            <li>Нажмите "Экспорт и отправить" - PDF скачается вам и отправится выбранному артисту в ЛК</li>
          </ol>
        </div>
      </CardContent>
    </Card>
