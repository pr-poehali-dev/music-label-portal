...
**Файл:** `backend/unread-counts/index.py`
...
### Сценарий 1: Директор назначил задачу менеджеру
...
3. **Менеджер обновляет статус** → без уведомлений (директор видит в списке)

---

**Статус:** ✅ Система работает исправно  
**Последнее обновление:** 2025-10-20 (исправлена логика уведомлений)  
**Версия:** 1.1